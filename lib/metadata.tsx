...
const metadataInfos: Metadata = {
  ...
  description:
    "Portfolio of Khilesh Mongse, software engineer passionate about web development, artificial intelligence, and SAP systems. Explore my projects, skills, and professional experience.",
  keywords: [
    "Khilesh Mongse",
    "web developer",
    "portfolio",
    ...
    images: [
      {
        ...
        width: 1856,
        height: 928,
        alt: "Preview of Khilesh Mongse's developer portfolio",
      },
    ],
    locale: "en_US",
    type: "website",
